...
@php
    $class = [
        ...
        'hover:bg-gray/20' => $variant == 'default' && !$destructive,
        'hover:bg-gray/20 hover:text-destructive' => $variant == 'default' && $destructive,
        ...
        'text-button hover:bg-button focus:bg-button active:bg-button hover:text-on-button' => $variant == 'text' && !$destructive,
        'text-destructive hover:bg-destructive focus:bg-destructive active:bg-destructive hover:text-on-button' => $variant == 'text' && $destructive,
