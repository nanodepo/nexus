<div class="fixed top-0 right-0 bottom-0 left-0 w-full h-full opacity-50 overflow-hidden -z-100 pointer-events-none">
    ...
    <svg class="absolute -bottom-[30vw] right-[10vw] h-[70vw] w-[70vw] opacity-30" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    <svg class="absolute bottom-0 -left-[30%] h-[60vw] w-[60vw] opacity-20" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    <canvas class="grain w-full h-full backdrop-blur-2xl" />
</div>
